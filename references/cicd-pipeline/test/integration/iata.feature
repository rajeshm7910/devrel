Feature: Airport by IATA code
  ...
  Scenario: I should be able to identify an airport by its IATA code
    When I GET /airports/FRA?apikey=NZrE6dsDKt9QK9NoTAMWbqA3tPYtPBINozjK8gs0rwAriopM
  ...
  Scenario: I should receive a 404 error for non-existing codes
    When I GET /airports/XYZ?apikey=NZrE6dsDKt9QK9NoTAMWbqA3tPYtPBINozjK8gs0rwAriopM
